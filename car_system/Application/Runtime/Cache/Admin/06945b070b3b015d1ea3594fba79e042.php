...
<div align="center">
    <table>
        ...
        <tr>
            <td>司机ID：</td>
            <td><input type="text" value="<?php echo ($ret["driver_id"]); ?>" name="driver_id" id="driver_id" disabled="disabled"></td>
        </tr>
        <tr>
            <td>司机名称：</td>
            <td><input type="text" value="<?php echo ($ret["driver_name"]); ?>" name="driver_name" id="driver_name" disabled="disabled"></td>
        </tr>
        <tr>
            <td>请选择权限：</td>
            <td>
