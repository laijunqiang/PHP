...
<div align="center">
    ...
    <table>
        ...
        <!--车辆ID-->
        <input type="hidden" value="<?php echo ($ret["car_id"]); ?>" name="car_id" id="car_id" disabled="disabled">
        <tr>
            <td>车牌号：</td>
            <td><input type="text" value="<?php echo ($ret["car_plate"]); ?>" name="car_plate" id="car_plate" disabled="disabled"></td>
        </tr>
        <tr>
            <td>目的地：</td>
        ...
        <tr>
            ...
            <td>
                <select name="order_status">
                    ...
                    <option value ="1" disabled="disabled" >已接单</option>
                    <option value ="2" selected="selected">已结束</option>
                </select>
            </td>
        </tr>
        <!--司机ID-->
        <input type="hidden" value="<?php echo ($ret["id"]); ?>" name="driver_id" id="driver_id" disabled="disabled">
        <tr>
            <td>司机编号：</td>
            <td><input type="text" value="<?php echo ($ret["number"]); ?>" name="driver_number" id="driver_number" disabled="disabled"></td>
        </tr>
        <tr>
            <td>提货单号：</td>
            <td><input type="text"  value="<?php echo ($ret["pick_number"]); ?>" name="pick_number" id="pick_number" disabled="disabled"></td>
        </tr>
        <tr>
            <td>合同号：</td>
            <td><input type="text"  value="<?php echo ($ret["contract_number"]); ?>" name="contract_number" id="contract_number" disabled="disabled"></td>
        </tr>
        <tr>
            <td>缺货信息：</td>
        ...
        <tr>
            <td>提货时间：</td>
            <td><input type="datetime-local" value="<?php echo ($ret["pick_time"]); ?>"  name="pick_time" id="pick_time" disabled="disabled"></td>
        </tr>
        <tr>
            <td>结算单位：</td>
        ...
        <tr align="center">
            <td colspan="2">
                <button onclick="personalOrder.update()">提交</button>
