...
<div align="center">
    ...
    <table>
        ...
        <tr>
            <td>司机密码：</td>
            <td><input type="password" value="<?php echo ($ret["password"]); ?>" name="password" id="password" disabled="disabled"></td>
        </tr>
        <tr>
            <td>真实姓名：</td>
        ...
        <tr>
            <td>头像路径：</td>
            <td><input type="text" value="<?php echo ($ret["image"]); ?>" name="image" id="image" disabled="disabled"></td>
        </tr>
    </table>
</div>
</body>
