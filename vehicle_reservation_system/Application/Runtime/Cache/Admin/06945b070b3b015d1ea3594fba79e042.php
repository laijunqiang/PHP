...
<div align="center">
    <table>
        ...
        <tr>
            <td>请选择权限：</td>
            <td>
                <?php if(($ret["order_manage"]) == "1"): ?><input type="checkbox" name="role" value="order_manage" checked="checked"/>排队管理权限
                <?php else: ?>
                    <input type="checkbox" name="role" value="order_manage" />排队管理权限<?php endif; ?>
                <?php if(($ret["driver_manage"]) == "1"): ?><input type="checkbox" name="role" value="driver_manage" checked="checked"/>司机管理权限
                <?php else: ?>
                    <input type="checkbox" name="role" value="driver_manage"/>司机管理权限<?php endif; ?>
                <?php if(($ret["oil_manage"]) == "1"): ?><input type="checkbox" name="role" value="oil_manage" checked="checked"/>油品管理权限
                    <?php else: ?>
                    <input type="checkbox" name="role" value="oil_manage"/>油品管理权限<?php endif; ?>
                ...
                <?php if(($ret["notice_manage"]) == "1"): ?><input type="checkbox" name="role" value="notice_manage" checked="checked"/>公告管理权限
                    <?php else: ?>
                    <input type="checkbox" name="role" value="notice_manage"/>公告管理权限<?php endif; ?>
            </td>
        </tr>
        <tr align="center">
            <td colspan="2">
