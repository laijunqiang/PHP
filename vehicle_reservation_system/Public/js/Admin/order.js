...
var order = {
    ...
    update: function () {
        ...
        var oldOrderNumber = $('input[name="oldOrderNumber"]').val();
        var newOrderNumber = $('select[name="newOrderNumber"] option:selected').val();
...
$('.select').change(function () {
    ...
    window.location.href = "../Order/select?status=" + status;
});
//复合查询
$('.search').click(function () {
    var status=$(".select option:selected").val();
    var searchTime=$('input[name="searchTime"]').val();
    window.location.href = "../Order/search?status=" + status+"&searchTime="+searchTime;
});
...
$('#excel').click(function () {
    ...
    if (status==""&&searchTime==""){
        ...
        window.location.href = "../Order/getExcel?status=" + status + "&searchTime=" + searchTime;
    }
});
...
$('#stop').click(function () {
    ...
    if (content=="暂停全部车辆排队"){
        window.location.href = "../Order/stop";
    }else {
