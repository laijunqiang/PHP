...
class PHPExcel_ReferenceHelper
{
	 ...
	 *
	 * @param   string   $a  First column to phpexcel (e.g. 'AA')
	 * @param   string   $b  Second column to phpexcel (e.g. 'Z')
	 * @return  integer
	 */
	 ...
	 *
	 * @param   string   $a  First cell to phpexcel (e.g. 'AA1')
	 * @param   string   $b  Second cell to phpexcel (e.g. 'Z1')
	 * @return  integer
	 */
